...
@Component({
  template: `
    <input
      class="block w-full border-gray-300 shadow-sm dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:ring-gray-500 focus:border-gray-500 sm:text-sm"
      [ngClass]="{
